...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h2 class="box-title"><b> Tambah Data Barang Keluar</b></h2>
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <form action="<?= site_url('stock/process') ?>" method="post">
                        ...
                        <div class="form-group">
                            <label>Detail *</label>
                            <input type="text" name="detail" id="detail" class="form-control" placeholder="habis, hilang, kadaluarsa" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button type="submit" name="stock_out_add" class="btn btn-success btn-flat">
