<section class="content-header">
    <h1>Report
        <small>Laporan Transaksi Penjualan</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i></a></li>
        <li>Laporan</li>
        <li class="active">Laporan Transaksi Penjualan</li>
    </ol>
</section>
...
<div class="row">
    ...
    <div class="col-lg-7" id="tanggalfilter">
        ...
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?= site_url('report/sale/filter') ?>" method="post" target="_blank">
                <div class="box-body">
    ...
    <div class="col-lg-7" id="bulanfilter">
        ...
        <div class="box box-info">
            ...
            <form id="formbulan" action="<?= site_url('report/sale/filter') ?>" method="post" target="_blank">
                <div class="box-body">
    ...
    <div class="col-lg-7" id="tahunfilter">
        ...
        <div class="box box-info">
            ...
            <form id="formtahun" action="<?= site_url('report/sale/filter') ?>" method="post" target="_blank">
                <input name="valnilai" type="hidden">
                <div class="box-body">
